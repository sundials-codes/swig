...
%fortran_typemap_complex(float _Complex, SWIG_ccomplex_construct, CTYPE, C_FLOAT_COMPLEX)
%fortran_typemap_complex(double _Complex, SWIG_ccomplex_construct, CTYPE, C_DOUBLE_COMPLEX)
